...
interface MultipartUploadInterface extends StorageInterface
{
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface<string> Promise that resolves to the unique token for the upload.
     */
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface<string> Promise that resolves to a token for the part.
     */
